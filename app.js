...
$(document).ready(function(){
  ...
  // As explained by Bobby; after splitting array item word, it is reassigned to
  // a li item and the letter is hidden but the data is kept
  ...
  // Check if Input is equal to any of the data items, if so reveal the
  // data-letter in the corresponding li item

  // Keypress event listener
  $('input').on('keypress', function(event) {

    // Checking for a keypress of the ENTER key
    if (event.which === 13) {
